...
# importing cv2 
import cv2 
image = cv2.imread("OpenCVWithPython/Assets/StichRevised.png")
...
import cv2
image = cv2.imread("OpenCVWithPython/Assets/StichRevised.png", 0)
start_point = (100, 50)
end_point = (125, 80)
color = (0, 0, 0)
thickness = -1
...
import cv2
image = cv2.imread("OpenCVWithPython/Assets/StichRevised.png.png")
window_name = 'Image'

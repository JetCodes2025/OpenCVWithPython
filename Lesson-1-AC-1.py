...
img = cv2.imread("OpenCVWithPython/Assets/StichRevised.png", cv2.IMREAD_COLOR)
...
img = cv2.imread("OpenCVWithPython/Assets/StichRevised.png", 0)
...
saved_directory = "C:/Desktop/Downloads/temp"
...
image = cv2.imread("OpenCVWithPython/Assets/StichRevised.png", 1)
